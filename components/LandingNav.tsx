      ...
      <div className="relative flex h-full items-center px-[clamp(1rem,3vw,3rem)]">
        ...
        <Link href="/" className="flex shrink-0 items-center" aria-label="OpenHex">
          <Image
            ...
            height={52}
            priority
            className="h-[35px] w-[35px] shrink-0 brightness-0 invert max-sm:h-8 max-sm:w-8"
          />
          <div className="inline-grid grid-cols-[max-content] grid-rows-[max-content] place-items-start leading-[0]">
            <Image
              ...
              height={24}
              priority
              className="col-start-1 row-start-1 block h-[18px] w-[88px] brightness-0 invert max-sm:h-[16px] max-sm:w-[78px]"
            />
            <p className="col-start-1 row-start-1 ml-[2px] mt-[17px] whitespace-nowrap text-[7.5px] font-medium leading-[1.5] tracking-[8.2px] text-white/70 max-sm:mt-[14px] max-sm:text-[6.5px] max-sm:tracking-[7px]">
              迷境智塔旗下
            </p>
          </div>
        </Link>
